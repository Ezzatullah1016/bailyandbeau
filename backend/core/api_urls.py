...
urlpatterns = [
    ...
    path("sessions/<uuid:pk>/token/", SessionGuestTokenView.as_view(), name="session-guest-token"),
    path("sessions/<uuid:pk>/transfer-host/", TransferHostView.as_view(), name="session-transfer-host"),
