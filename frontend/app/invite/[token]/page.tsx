...
/**
 * Guest invite landing page — /invite/<token>
 *
 * No account required. Guest enters their display name, the invite is
 * consumed via POST /invites/{token}/join/, then they are redirected to
 * the reading room with their token stored in SessionContext.
 */
export default function InviteJoinPage() {
  ...
  async function handleJoin() {
    ...
    try {
      ...
      // Persist participant_id so guest can refresh their token on reconnect
  ...
  return (
    <>
      <link
        rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Newsreader:ital,wght@0,400;0,600;0,700;1,400&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap"
      />
      <link
        rel="stylesheet"
      ...
      <style>{`
        ...
        .pulse-amber {
          box-shadow: 0 0 0 0 rgba(254,174,44,0.7);
          animation: pulse-ring 2s infinite;
        }
        @keyframes pulse-ring {
          0%   { transform: scale(0.95); box-shadow: 0 0 0 0  rgba(254,174,44,0.7); }
          70%  { transform: scale(1);    box-shadow: 0 0 0 10px rgba(254,174,44,0); }
          100% { transform: scale(0.95); box-shadow: 0 0 0 0  rgba(254,174,44,0); }
        }
      `}</style>
            ...
            <div className="max-w-md mx-auto space-y-8">
              ...
              <div className="bg-[#f3ede3] rounded-xl p-6">
                <div className="flex items-center gap-2 mb-2">
                  <span className="material-symbols-outlined text-[#835500]">auto_stories</span>
